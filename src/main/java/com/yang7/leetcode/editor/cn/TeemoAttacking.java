...
public class TeemoAttacking {
    public static void main(String[] args) {
        ...
        System.out.println(solution.findPoisonedDuration(new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9}, 5));//13
    }
    ...
    class Solution {
        public int findPoisonedDuration(int[] timeSeries, int duration) {
            ...
            for (int i = 0; i < n; i++) {
                //是否在中毒期间
                total += expire <= timeSeries[i] ? duration : timeSeries[i] + duration - expire;
