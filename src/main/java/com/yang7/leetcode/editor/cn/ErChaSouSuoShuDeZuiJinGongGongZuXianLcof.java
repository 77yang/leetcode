...
// Related Topics 树 深度优先搜索 二叉搜索树 二叉树 👍 203 👎 0
...
//          System.out.println(solution.lowestCommonAncestor(TreeNodeUtil.createTreeNode(new Integer[]{6,2,8,0,4,7,9,null,null,3,5}), ));
      }
